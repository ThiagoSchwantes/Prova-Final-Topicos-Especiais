...
import './css/App.css';
import CadastrarTarefa from './componets/CadastrarTarefa';
import ListaTarefasConcluidas from './componets/ListaTarefasConcluidas';
import ListaTarefasNaoConcluidas from './componets/ListaTarefasNaoConcluidas';
